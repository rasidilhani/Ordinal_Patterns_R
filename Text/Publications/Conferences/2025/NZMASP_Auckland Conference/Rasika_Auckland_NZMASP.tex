...
\begin{document}
	...
	\begin{frame}{Motivation and Background}
		\small
		\begin{itemize}
			\item Clustering time series is challenging since every series analyzed contains a stochastic component, contributing random variability and increased complexity.
...
\begin{frame}
	...
	\begin{columns}
		...
		\includegraphics[width=\linewidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/New_model_group_plot_n500}
...
\begin{frame}
	...
	\begin{columns}
		...
		\end{itemize}
		\column{0.45\textwidth}
		\includegraphics[width=\linewidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Median_HC_Shannon_Entropy_case1.pdf}
...
\begin{frame}{Case Study Design}
	\begin{itemize}
		...
		\item Two sample sizes: $n=500, n=1000$.
...
\begin{frame}{Case 1 — Positive Coefficients}
	\centering
	\includegraphics[width=0.7\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Combined3Plots_Case1_n1000.pdf}
...
\begin{frame}{Case 2 — Negative Coefficients}
	\centering
	\includegraphics[width=0.7\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Combined3Plots_Case2_n500.pdf}
	\captionof{figure}{Entropy–complexity scatter plot and associated time series ($n=500$) for  negative parameters.}
\end{frame}

\begin{frame}{Case 2 — Negative Coefficients}
	\centering
	\includegraphics[width=0.7\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Combined3Plots_Case2_n1000.pdf}
...
\begin{frame}{Case 3 — Mixed-Sign Coefficients}
	\begin{columns}[c] % 'c' centers content vertically
		...
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Combined3Plots_Case3_n500.pdf}
		\captionof{figure}{Entropy–complexity scatter plot and associated time series ($n=500$) for mixed-sign coefficients.}
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Combined3Plots_Case3_n1000.pdf}
...
\begin{frame}{Extended Cases}
	...
	\begin{columns}[c]
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Scatter_Selected_Case1_n1000.pdf}
		\captionof{figure}{Scatter plot for selected models in the entropy–complexity plane for Case 1.}
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/new_centralpoint_timeseries_Case1_n1000.pdf}
...
\begin{frame}{Extended Cases cont\dots}
	\begin{columns}[c]
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Scatter_Selected_Case2_n1000.pdf}
		\captionof{figure}{Scatter plot for selected models in the entropy–complexity plane for Case 2.}
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/new_centralpoint_timeseries_Case2_n1000.pdf}
		\captionof{figure}{Representative time series around their central $(H^*, C^*)$ points.}
	\end{columns}
\end{frame}
...
\begin{frame}{Extended Cases cont\dots}
	\begin{columns}[c]
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/Scatter_Selected_Case3_n1000.pdf}
		\captionof{figure}{Scatter plot for selected models in the entropy–complexity plane for Case 3.}
		\column{0.48\textwidth}
		\centering
		\includegraphics[width=\textwidth]{C:/Users/UserA1/Documents/GitHub/Ordinal_Patterns_R/Plots/Auckland & Dunedin Conference related plots/new_centralpoint_timeseries_Case3_n1000.pdf}
		\captionof{figure}{Representative time series around their central $(H^*, C^*)$ points.}
	\end{columns}
\end{frame}
