...
The quadrant representing Motor Themes includes topics such as entropy, signal processing, and machine learning, indicating well-developed and highly interconnected areas of research. %%% ACF What are Motor Themes? 
Basic Themes include permutation entropy and time series analysis, which are foundational topics in the field and closely align with the focus of this thesis. %%% ACF What are Basic Themes... and so on
...
Without blahblahblah, we identified the following topics into which we will structure our review of the literature:
\begin{itemize}
