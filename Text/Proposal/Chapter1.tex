...
%%% ACF Did B&P say that the replacement/tranformation/symbolisation is used when the time series is infinite?
If the $\bm{x}$ takes infinitely many values, it is common to replace them with a symbol sequence $\bm{{\pi}}=({\pi}_1, {\pi}_2,\dots, {\pi}_n)$
