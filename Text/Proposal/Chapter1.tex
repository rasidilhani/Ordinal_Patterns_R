...
\begin{figure}[hbt]
		\centering
		\includegraphics[width=0.99\textwidth]{time series plots}
...
Chapter~\ref{C:lit} will review the literature on ordinal pattern analysis. Chapter~\ref{C:aim} will expand on ordinal pattern concept by exploring the characterization of time series and cover the computation of two key descriptors entropy and complexity from the resulting histograms.  Additionally, Chapter~\ref{C:futw} will outline the main ideas and objectives of this research project.      
