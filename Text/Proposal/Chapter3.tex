...
After computing all symbols as described in Chapter 1, the histogram proportions are used to estimate the probability distribution of ordinal patterns. From this distribution, two key descriptors are calculated to characterize the time series:
\begin{enumerate}
...
This section examines three key aspects:
\begin{enumerate}
...
The discussion concludes with a real-world case study demonstrating how these asymptotic distributions can be applied to analyze entropy and complexity patterns. Crucially, these asymptotic results remain valuable approximations even when the strict assumptions of the multinomial model are not fully satisfied.  

Transforming observations into symbols 
