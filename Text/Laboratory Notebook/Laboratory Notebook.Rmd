...
The convergence behavior of the asymptotic variance for some types of dynamics and the permutation entropy to the limit distribution results lead to tests for comparing the underlying dynamics of two time series[@REY2024115481]. We apply these tests results to discriminate uniform white noise of bearing fault detection. 
