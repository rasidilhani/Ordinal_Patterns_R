...
\abstract{This research focuses on identifying perturbations in machines
using time series data, a process where detecting chaotic patterns poses
significant challenges. Bandt and Pompe introduced a novel approach to
analyze time series through ordinal patterns, which facilitates the
extraction of qualitative information from nonlinear data efficiently
and automatically. Their concept of permutation entropy provides a
measure of the complexity inherent in a system, leveraging the ordinal
patterns that capture variations within a time series.However,
permutation entropy addresses only one aspect of a time series' ordinal
structure, which limits its scope. A critical challenge in pattern
classification systems lies in effective feature selection. This study
investigates methods to provide classification systems with the most
defining features for ordinal multi-class classification. By integrating
cluster and variability analyses, an innovative and efficient feature
selection scheme is proposed. Additionally, the research demonstrates
how to process real-valued datasets to extract all relevant ordinal
information, advancing the ability to analyze and classify complex time
series data comprehensively.}
