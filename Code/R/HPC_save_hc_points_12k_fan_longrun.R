...
for(D in 3:6){
  ...
  print(sprintf("Run ML - %s, D - %s %s", ML, D, Sys.time()))
  ...
  write.csv(HCPoints, file.path(base_path, "Data", "csv", "12k_fan_ML_2_and_3", sprintf("HCPoints_%s_ML_%s_D_%s.csv", dataset_type, ML, D)))
